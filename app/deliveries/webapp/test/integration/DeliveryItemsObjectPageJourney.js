...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("DeliveryItemsObjectPageObjectPage journey");

        opaTest("Navigate to DeliveryItemsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheDeliveriesObjectPage.onTable({ property: "items" }).iCheckRows();
            When.onTheDeliveriesObjectPage.onTable({ property: "items" }).iPressRow(0);

            Then.onTheDeliveryItemsObjectPage.iSeeThisPage();
        });
